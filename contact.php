...
?>
  ...
  <form name="contact" action="action_contact.php"  method="POST"  >
    ...
    <tr>
       <td><br /><br /></td>
       <td><input type="submit" value="ارسال" style="text-decoration: none; background-color:#009688; padding-left:30px; padding-right:30px; border-radius:10px; font-family:inherit;" />&nbsp;&nbsp;&nbsp;<input type="reset" value="جديد" style="text-decoration: none; background-color:#009688; padding-left:30px; padding-right:30px; border-radius:10px; font-family:inherit;"/></td>
    </tr>
