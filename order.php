               ...
               <table style="width: 100%;" border="0" style="margin-left: auto;margin-right: auto;">
                  ...
                  <tr>
                     ...
                     <td><input type="text" style="text-align: left;background-color: lightgray;" id="pro_price"
                           name="pro_price" value="<?php echo ($row['pro_price']); ?>" readonly /> تومان</td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <td><input type="text" style="text-align: left;background-color: lightgray;" id="total_price"
                           name="total_price" value="0" readonly /> تومان</td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <td><textarea style="text-align: right;font-family:inherit; width: 170px;" id="address" name="address" cols="30"
                  ...
                  <tr>
                     <td><br /><br /><br /><br /></td>
                     <td><input type="button" value="خرید محصول" onclick="check_input();" style="text-decoration: none; background-color:#009688; padding-left:40px; padding-right:40px; padding-top:10px; padding-bottom:10px; border-radius:10px; font-family:inherit; width: 170px; text-align:center;"/></td>
                  </tr>
               ...
               <table>
                  <tr>
                     <td style="vertical-align: top;width: 33%; text-align:center; ">
                        <h4 style="color: #004D40; height: 20px; font-size:30px;"><?php echo ($row['pro_name']) ?></h4>
                        <img src="images/products/<?php echo ($row['pro_image']) ?>" width="250px" height="120px" style="border-radius: 10px; border:2px solid #004D40;  object-fill:cover;" />
                        <br />
                        قیمت واحد : <?php echo ($row['pro_price']) ?>&nbsp; تومان
                        <br />
                        مقدار موجودي : <span style="color:#C2185B;"><?php echo ($row['pro_qty']) ?></span>
                        <br />
                        توضيحات : <div style="color:#006064; margin-bottom:5px; width: 100%;">
                           <?php
